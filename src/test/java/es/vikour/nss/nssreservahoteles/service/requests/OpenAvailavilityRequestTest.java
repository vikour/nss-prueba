...
class OpenAvailavilityRequestTest {
	...
	private static final int VALID_HOTEL_ID = 1;
	
	public static Validator validator;
	public OpenAvailavilityRequest validRequest;
	...
	public void setUpTest() {
		...
		validRequest = new OpenAvailavilityRequest();
		validRequest.setHotelId(VALID_HOTEL_ID);
	...
	public void testValidRequest_thenCorrect() {
		Set<ConstraintViolation<OpenAvailavilityRequest>> validations = validator.validate(validRequest);
	...
	public void testNumberRooms_whenNull_thenError() {
		...
		assertExistsValidationMessage(validations, Constants.MSG_NUMERO_HABITACIONES_OBLIGATORIO);
	}
	
	@Test
	@DisplayName("El id del hotel no debe de ser nulo")
	public void testHotelId_whenNull_thenError() {
		validRequest.setHotelId(null);
		
		Set<ConstraintViolation<OpenAvailavilityRequest>> validations = validator.validate(validRequest);
		
		assertExistsValidationMessage(validations, Constants.MSG_HOTEL_ID_OBLIGATORIO);
	}
	...
	public void testNumberRooms_whenZero_thenError() {
		...
		Set<ConstraintViolation<OpenAvailavilityRequest>> validations = validator.validate(validRequest);
		assertExistsValidationMessage(validations, Constants.MSG_NUMERO_HABITACIONES_MINIMO);
	...
	public void testStartDate_whenNull_thenError() {
		...
		Set<ConstraintViolation<OpenAvailavilityRequest>> validations = validator.validate(validRequest);
		assertExistsValidationMessage(validations, Constants.MSG_FECHA_INICIO_OBLIGATORIA);
	}
	...
	public void testEndDate_whenNull_thenError() {
		...
		Set<ConstraintViolation<OpenAvailavilityRequest>> validations = validator.validate(validRequest);
		assertExistsValidationMessage(validations, Constants.MSG_FECHA_FIN_OBLIGATORIA);
	}
	...
	public void testStartDate_whenNotLessThanEndDate_thenError() {
		...
		Set<ConstraintViolation<OpenAvailavilityRequest>> validations = validator.validate(validRequest);
		assertExistsValidationMessage(validations, Constants.MSG_FECHA_INICIO_FIN_INVALIDAS);
